...
--
-- Table structure for table `chartdate`
--

CREATE TABLE `chartdate` (
  `id` int(255) NOT NULL,
...
--
-- Dumping data for table `chartdate`
--

INSERT INTO `chartdate` (`id`, `firstday`, `lastday`) VALUES
...
CREATE TABLE `exist` (
  ...
  `prints` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `exist`
--

INSERT INTO `exist` (`id`, `open`, `edits`, `prints`) VALUES
(1, 1, 1, 1);
...
--
-- Table structure for table `id_value2`
--

CREATE TABLE `id_value2` (
  `id` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `m1` (
  `id` int(10) NOT NULL,
  `sign_id` varchar(200) DEFAULT NULL,
  `test_id` varchar(10) NOT NULL,
  `test_room` varchar(255) NOT NULL,
  `img` varchar(255) NOT NULL,
  `img_page1` varchar(255) NOT NULL,
  `img_page2` varchar(255) NOT NULL,
  `img_page3` varchar(255) NOT NULL,
  `stat` varchar(255) NOT NULL,
  `sign_when` timestamp NOT NULL DEFAULT current_timestamp(),
  `edit_when` timestamp NOT NULL DEFAULT current_timestamp(),
  `title` varchar(255) NOT NULL,
  `firstname` varchar(255) NOT NULL,
  `lastname` varchar(255) NOT NULL,
  `oldschool` varchar(255) NOT NULL,
  `OS_Province` int(20) NOT NULL,
  `address` varchar(255) NOT NULL,
  `AD_Province` int(20) NOT NULL,
  `AD_District` int(20) NOT NULL,
  `AD_Subdistrict` int(20) NOT NULL,
  `pid` varchar(255) NOT NULL,
  `date` varchar(255) NOT NULL,
  `StPN` varchar(255) NOT NULL,
  `PaFirstname` varchar(255) NOT NULL,
  `PaLastname` varchar(255) NOT NULL,
  `PaPN` varchar(255) NOT NULL,
  `p1` int(10) NOT NULL,
  `p2` int(10) NOT NULL,
  `p3` int(10) NOT NULL,
  `urole` varchar(255) NOT NULL,
...
--
DELIMITER $$
CREATE TRIGGER `getIDs` BEFORE INSERT ON `m1` FOR EACH ROW BEGIN
     INSERT INTO id_value2 VALUES (NULL);
     SET NEW.sign_id = CONCAT(LPAD(LAST_INSERT_ID(), 4, "0"));
                END
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `getID` BEFORE INSERT ON `m4` FOR EACH ROW BEGIN
...
--
-- Table structure for table `plan1`
--
...
--
-- Dumping data for table `plan1`
--

INSERT INTO `plan1` (`id`, `planned`) VALUES
(1, 'ห้องเรียนปกติ\n'),
(2, 'ห้องเรียนวิทยาศาสตร์พลังสิบ\n'),
(3, 'ห้องเรียนเน้นภาษาจีน\n'),
(4, 'ไม่ประสงค์เลือก');

-- --------------------------------------------------------

--
-- Table structure for table `plan4`
--
...
--
-- Dumping data for table `plan4`
--

INSERT INTO `plan4` (`id`, `planned`) VALUES
(1, 'วิทยาศาสตร์ - คณิตศาสตร์\n'),
(2, 'วิทยาศาสตร์ - พลังสิบ\n'),
(3, 'ศิลป์ - คำนวณ\n'),
(4, 'ศิลป์ - บัญชี\n'),
(5, 'ศิลป์ - ภาษาจีน'),
(6, 'ศิลป์ - ภาษาเกาหลี'),
(7, 'ศิลป์ - ภาษาอังกฤษ'),
(8, 'ศิลป์ - ภาษาญี่ปุ่น'),
(9, 'ศิลป์ - ภาษาฝรั่งเศส'),
(10, 'ศิลป์ - ศิลปะ'),
(11, 'ศิลป์ - ดนตรี'),
(12, 'ศิลป์ - นิติฯ - รัฐศาสตร์'),
(13, 'ไม่ประสงค์เลือก');
...
--
-- Table structure for table `test1_room`
--

CREATE TABLE `test1_room` (
  `id` int(10) NOT NULL,
  `room` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `test1_room`
--

INSERT INTO `test1_room` (`id`, `room`) VALUES
(1, '112'),
(2, '113'),
(3, '114'),
(4, '115'),
...
--
-- Table structure for table `test4_room`
--

CREATE TABLE `test4_room` (
  `id` int(10) NOT NULL,
  `room` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `test4_room`
--

INSERT INTO `test4_room` (`id`, `room`) VALUES
(1, '111'),
(2, '112'),
(3, '113'),
(4, '114');
...
--
-- Indexes for table `chartdate`
--
ALTER TABLE `chartdate`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `id_value2`
--
ALTER TABLE `id_value2`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `plan1`
--
ALTER TABLE `plan1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `plan4`
--
ALTER TABLE `plan4`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `test1_room`
--
ALTER TABLE `test1_room`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `test4_room`
--
ALTER TABLE `test4_room`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `chartdate`
--
ALTER TABLE `chartdate`
...
--
-- AUTO_INCREMENT for table `id_value2`
--
ALTER TABLE `id_value2`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `plan1`
--
ALTER TABLE `plan1`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `plan4`
--
ALTER TABLE `plan4`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT for table `test1_room`
--
ALTER TABLE `test1_room`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `test4_room`
--
ALTER TABLE `test4_room`
