...
<?php include 'navB.php';?>
    ...
    <div class="container">
        ...
        <div id="result"></div>
            ...
            <hr>
            <form id="signinForm" action="signin_db.php" method="post" class="needs-validation" novalidate>
                
                <div class="row">
                    <div class="col-md-4">
                        <label for="pid" class="form-label">เลขบัตรประชาชน 13 หลัก</label>
                        <input type="text" class="form-control" name="pid" id="pid" minlength="13" maxlength="13" pattern="[0-9]*" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="date" id="date" pattern="\d{2}/\d{2}/\d{4}" required>
                        <div class="invalid-feedback">
                            กรุณากรอกข้อมูล และกรอกรูปแบบให้ถูกต้อง 
                        </div>
                    </div>        
                    ...
                    <div class="col-md-3">
                        <br>
                        <!-- เปลี่ยนปุ่มเป็นปุ่มสำหรับการทดสอบ -->
                        <button type="button" id="submitBtn" class="btn btn-outline-primary">ตรวจสอบ</button>
                    </div>           
                </div>
            </form>
        </div>
    ...
    <script src="assets/signin_ajax.js"></script>
