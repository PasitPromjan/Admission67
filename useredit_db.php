...
<?php 
    ...
    if (isset($_POST['update'])) {
        ...
        if($classed == "1"){
            ...
            $sql = $conn->prepare("UPDATE m4 SET p1= :p1, p2= :p2, p3=:p3,p4= :p4, p5= :p5, p6=:p6,p7= :p7, p8= :p8, p9=:p9,p10= :p10, p11= :p11, p12=:p12,stat= :stat, title= :title, firstname =:firstname, lastname =:lastname, pid= :pid, StPN= :StPN, PaFirstname= :PaFirstname, PaLastname= :PaLastname, PaPN= :PaPN, img =:img,edit_when = current_timestamp, img_page1= :img_page1,img_page3= :img_page3, img_page2= :img_page2, oldschool= :oldschool, OS_Province= :OS_Province, address= :address, AD_Province= :AD_Province, AD_Subdistrict =:AD_Subdistrict, AD_District= :AD_District, date= :date WHERE id = :id");
            $sql->bindParam(":id", $id);
            $sql->bindParam(":p1", $p1);
            $sql->bindParam(":p2", $p2);
            $sql->bindParam(":p3", $p3);
