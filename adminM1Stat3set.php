              ...
              <?php if (isset($_GET['class'])) {
                ...
                ?>
                    <tr>
                        ...
                        ?>
                        <td><?php echo $user['test_room']." (".$result['room'].")"; ?> </td>    
                        <?php } } ?>
                        ...
                        <?php
                          ...
                          $stat = '3';
                            if($class == "4"){
                                $room = $test-41000; 
                                $room = floor(($room-1) / 30)+1;
                                //echo $room;
                                $sql = $conn->prepare("UPDATE m4 SET test_room=:room,test_id=:test, stat=:stat WHERE id = :ids");
                            }
                            else if($class == "1"){
                                $room = $test-11000; 
                                $room = floor(($room-1) / 30)+1;
                                //echo $room;
                                $sql = $conn->prepare("UPDATE m1 SET test_room=:room,test_id=:test, stat=:stat WHERE id = :ids");
                            }
