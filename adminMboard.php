    ...
    <div class="container-fluid">
        <div class="bg-light p-5 rounded">
            ...
            <main class="col py-3">
                ...
                <form id="searchForm" class="form-group my-3">
                    <div class="row">
                        <div class="col-6">
                            <input type="text" placeholder="กรอกชื่อนักเรียน" class="form-control" name="data" id="searchInput" required>
                        </div>
                    </div>
                </form>
...
<script>
    $(document).ready(function(){
        $('#searchInput').on('keyup', function(){
            ...
            if (query !== '') {
                $.ajax({
                    url: 'adminMsearch.php',
                    method: 'GET',
                    data: { query: query, class: "<?php echo $class; ?>", stat: "<?php echo $stat; ?>" },
                ...
                $.ajax({
                    url: 'adminMsearch.php',
                    method: 'GET',
                    data: { class: "<?php echo $class; ?>", stat: "<?php echo $stat; ?>" },
                    success: function(data) {
                        $('#results').html(data);
                    }
                });
    ...
    <!--<script src="assets/adminMboard.js"></script>-->
