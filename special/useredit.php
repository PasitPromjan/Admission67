                ...
                ?>
                   <div class='row'>
                        ...
                        <h5 class='text-success'>ข้อมูลนักเรียน</h5>
                            ...
                            <label>วันเกิด</label>
                            <input id="datepicker" value="<?php echo $row['date']; ?>" width="276" name="date" />
                            <script>
                    ...
                    <div class="row ">
                        ...
                        <div class="mb-3">
                            ...
                            <h6>ไฟล์เดิม <a href="uploads/<?php echo $row['img_page1']; ?>"> <?php echo $row['img_page1']; ?></a></h6>
                        ...
                        <div class="mb-3">
                            ...
                            <h6>ไฟล์เดิม <a href="uploads/<?php echo $row['img_page2']; ?>"> <?php echo $row['img_page2']; ?></a></h6>
