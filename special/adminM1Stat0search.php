    ...
    <div class="row flex-nowrap">
      <?php include 'adminSIDEBAR.php';?>  
        ...
        <main class="col py-3">
            ...
            <form action=" adminM1Stat0search.php" class="form-group my-3" method="POST">
              <div class="row">
                <div class="col-6">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                <?php if (isset($_GET['class'])) {
                        ...
                        $data = $_POST["data"];
                        if($class == "4"){
                            $stmt = $conn->query("SELECT * FROM m4 WHERE (stat='0' and urole='user') and firstname LIKE '%$data%'");
                            $stmt->execute();
                        }
                        else if($class == "1"){
                            $stmt = $conn->query("SELECT * FROM m1 WHERE (stat='0' and urole='user') and firstname LIKE '%$data%'");
                            $stmt->execute();
                        }
                        $users = $stmt->fetchAll();
                      }
