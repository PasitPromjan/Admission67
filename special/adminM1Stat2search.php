  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
      ...
      <?php
        ...
        <main class="col py-3">
            <div class="container">
            <h1 class="text-center mt-3">รายชื่อนักเรียนที่ยังไม่ลงทะเบียน</h1>
            <form action=" adminM1Stat2search.php" class="form-group my-3" method="POST">
              <div class="row">
                <div class="col-6">
            ...
            <table class="table table-bordered">
              ...
              <?php if (isset($_GET['class'])) {
                        ...
                        $data = $_POST["data"];
                        if($class == "4"){
                            $stmt = $conn->query("SELECT * FROM m4 WHERE (stat='2' and urole='user') and firstname LIKE '%$data%'");
                            $stmt->execute();
                        }
                        else if($class == "1"){
                            $stmt = $conn->query("SELECT * FROM m1 WHERE (stat='2' and urole='user') and firstname LIKE '%$data%'");
                            $stmt->execute();
                        }
                        $users = $stmt->fetchAll();
                      }
