...
<?php  include 'nav.php'; ?>
    ...
    <div class="container">
        <br>
        <form action="signupM1_db.php" method="POST"  enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="bg-light p-5 rounded">
                
            <h4 class='text-center text-dark alert alert-warning'>สมัครเรียนชั้นมัธยมศึกษาปีที่ 1 ประเภทห้องเรียนพิเศษฯ</h4>
                <hr>
                ...
                <div class="mb-3">
                    <div class="row text-center">
                        ...
                        <h4>หลักฐานที่ต้องใช้ในการสมัคร</h4>
                            ...
                            2.เอกสารแสดงว่ากำลังศึกษาหรือจบการศึกษา ปพ.1  "ด้านหน้า"  หรือ ใบรับรองผลการเรียน ปพ.7 ที่แสดงผลการเรียน ป.4-5 <br>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <label>เลขบัตรประชาชน / เลขบัตรคนต่างด้าว</label>
                            <input type='text' name='pid' required class='form-control' id="validationCustom04" >
                            <div class="invalid-feedback">
                                กรุณากรอกข้อมูล
                            </div>
                    ...
                    <div class="row g-3">    
                        <h5 class='text-primary'>หลักฐานประกอบการสมัคร (ไฟล์ประเภท png , jpeg , jpg )</h5>
                        <div class="col-md-8">
                            <label for="img2" class="form-label">ปพ 1 ด้านหน้า หรือใบรับรองผลการเรียน</label>
                            <input class="form-control"  type="file" id="img2" name="img_page1" required>
                        </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <input class="form-control" type="file" id="img3" name="img_page2" required>
                        </div>
                        <div class="col-md-4">
