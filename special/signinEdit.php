        ...
        <div class="bg-light p-5 rounded">
            <form action="signinEdit_db.php" method="post" class="needs-validation" novalidate>
                <?php if (!isset($_GET['id'])&&!isset($_GET['class'])) { ?>
                    <h3 class="mt-4">แก้ไขข้อมูลการสมัคร ชั้นมัธยมศึกษาปีที่ 1 และ 4 ประเภทห้องเรียนพิเศษฯ</h3>
                    <hr>
               ...
               <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label for="pidLogin" class="form-label">เลขบัตรประชาชน / เลขบัตรคนต่างด้าว</label>
                        <input type="pidLogin" class="form-control" name="pidLogin" required>
            ...
            <?php if (isset($_GET['id'])&&isset($_GET['class'])) {  ?>
                <br>
                <h1>แก้ไขข้อมูล ชั้นมัธยมศึกษาปีที่ <?php echo $class; ?> ประเภทห้องเรียนพิเศษฯ</h1>
            <hr>
                     ...
                     <br>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type='text' readonly name='pid' value="<?php echo $row['pid']; ?>"  class='form-control'>
                            </div>
                            <div class="col-md-3">
                                <label for="datepicker2" class="form-label">วันเกิด</label>
                                <input type='text' readonly name='date' value="<?php echo $row['date']; ?>" pattern="\d{2}/\d{2}/\d{4}"  class='form-control'>
                            </div>
                            <div class="col-md-5">
