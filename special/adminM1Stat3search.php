  ...
  <div class="container-fluid">
    ...
    <?php
        ...
        <main class="col py-3">
            ...
            <form action=" adminM1Stat3search.php" class="form-group my-3" method="POST">
              <div class="row">
                <div class="col-6">
            ...
            <table class="table table-bordered">
              ...
              <?php if (isset($_GET['class'])) {
                        ...
                        $class = $_GET['class'];
                        if($class == "4"){
                            $stmt = $conn->query("SELECT * FROM m4 WHERE (stat='2' and urole='user') ORDER BY firstname");
                            $stmt->execute();
                        }
                        else if($class == "1"){
                            $stmt = $conn->query("SELECT * FROM m1 WHERE (stat='2' and urole='user') ORDER BY firstname");
                            $stmt->execute();
                        }
                        $users = $stmt->fetchAll();
                      }
