<?php
    ...
    try {
        $conn = new PDO("mysql:host=$servername;dbname=wattanai_ad67special", $username, $password);
...
//	$conn->setAttribute(PDO::SQLSRV_ATTR_ENCODING, PDO::SQLSRV_ENCODING_UTF8);
    ...
    try {
        $pdo = new PDO("mysql:host=$servername;dbname=wattanai_ad67special", $username, $password);
        // set the PDO error mode to exception
