        ...
        <main class="col py-3">
            ...
            <table class="table table-bordered">
              ...
              <?php if (isset($_GET['class'])) {
                        ...
                        $data = $_POST["data"];
                        if($class == "4"){
                            $stmt = $conn->query("SELECT * FROM m4 WHERE (stat='1' and urole='user') and firstname LIKE '%$data%'");
                            $stmt->execute();
                        }
                        else if($class == "1"){
                            $stmt = $conn->query("SELECT * FROM m1 WHERE (stat='1' and urole='user') and firstname LIKE '%$data%'");
                            $stmt->execute();
                        }
                        $users = $stmt->fetchAll();
                      }
