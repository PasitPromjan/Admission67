...
<div class="container-fluid">
    <div class="bg-light p-5 rounded">  
            ...
            <form action="adminallow_db.php" method="post" enctype="multipart/form-data">    
                    ...
                    <h1>ตรวจสอบข้อมูล</h1>
                <hr>
                    <button type="submit" name="allow" class="btn btn-primary">ผ่านการตรวจสอบ</button>
                    <hr>
                    <div class="row">
                        <div class="col-md-1"><button type="submit" name="sentComment" class="btn btn-primary">ส่งการแก้ไข</button></div>
                        <div class="col-md-4"><input type="text"  class="form-control"  name="comment"></div>
                        <input type="hidden" value="<?php echo $data['firstname']." ".$data['lastname']; ?>" name="checkby" required class="form-control" name="firstname" >
                   ...
                   <div class='row'>
                     ...
                     <br>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input id="datepicker2" disabled value="<?php echo $row['date']; ?>" width="276" name="date" />
                                <script>
                            ...
                            <div class="col-md-9">
                                ...
                                <input type='text' disabled name='pid' value="<?php echo $row['pid']; ?>" required class='form-control'>
                            </div>
                        <div>
                    ...
                    <div class="row ">
                        ...
                        <div class="mb-3">
                            ...
                            <h6> <a href="uploads/<?php echo $row['img_page1']; ?>" target="_blank"> <?php echo $row['img_page1']; ?></a></h6>
                        </div>
                        <div class="mb-3">
                            <label for="img3" class="form-label">ปพ 1 ด้านหลัง (ถ้าไม่มีให้ใช้ไฟล์เดียวกับ ปพ1 ด้านหน้า)</label>
                            <h6> <a href="uploads/<?php echo $row['img_page2']; ?>" target="_blank"> <?php echo $row['img_page2']; ?></a></h6>
                        </div>
                    </div>
